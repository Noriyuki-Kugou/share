(function(ext) {
    ...
    var descriptor = {
        blocks: [
            ['h', 'Rulo When %m.rulo_button button pressed', 'rulo_button_hat', 'スタート&ストップ'],
            [' ', 'Rulo Operation mode %m.rulo_mode_name', 'rulo_mode','normal'],
            [' ', 'Rulo Front Rear %n cm/s Left and Right %n deg/s', 'rulo_cmd_vel', '30','0'],
            [' ', 'Rulo Operation Stop', 'rulo_stop_move'],
            [' ', 'Rulo Go straight %n cm', 'rulo_straight', '100'],
            [' ', 'Rulo Trun %n deg', 'rulo_turn', '90'],
            [' ', 'Rulo Cleaning Suction %n % Brush %n %', 'rulo_clean', '50','50'],
            [' ', 'Rulo Cleaning stop', 'rulo_stop_crean'],
            ...
            [' ', 'Speak %s', 'ros_speak', 'hello'],
            ['h', 'Detect %m.object', 'object_recognition', 'person'],
            ['r', 'Person num', 'object_num'],
            ['b', 'Moving', 'is_moving'],
        ],
        menus: {
